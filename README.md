  ...
  <tr>
    <td width="50%" align="center" valign="top">
      <a href="Docs/Screenshots/05-run-library.jpg">
        <img src="Docs/Screenshots/thumbs/05-run-library.jpg" alt="Run library" width="420" />
      </a><br />
      <sub>Run Library</sub>
    </td>
    <td width="50%" align="center" valign="top">
      <a href="Docs/Screenshots/06-run-detail.jpg">
        <img src="Docs/Screenshots/thumbs/06-run-detail.jpg" alt="Run detail planner" width="420" />
      </a><br />
